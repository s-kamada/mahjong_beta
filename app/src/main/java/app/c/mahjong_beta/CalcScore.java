...
//                calc.score = multiplier * calc.basicScore;
                ...
                if (calc.score > Score.MANGAN) { //満貫(3-70以上 or 4-40以上)
                    calc.score = Score.MANGAN;
                    calc.basicScore = Score.BASIC_SCORE_MANGAN;
                    calc.scoreStat = Score.STR_MANGAN;
                }
                break;
            case 5: //5飜　満貫
