...
//                calc.score = multiplier * calc.basicScore;
                ...
                if (calc.basicScore > Score.BASIC_SCORE_MANGAN) { //満貫(3-70以上 or 4-40以上)
                    ...
                    calc.scoreStat = Score.STR_MANGAN + "(" + calc.scoreStat +"符)";
                }
                break;
            case 5: //5飜　満貫
                calc.score = multiplier * Score.BASIC_SCORE_MANGAN;
